  ...
  readonly pageContent = [
    {
      ...
      sidenote: 'My final project for the bachelor\'s degree was a 3D educational application in Unity (programming included), for which the focus of the thesis was graphics for interactable experiences.',
    },
    {
      title: '2012 - Freelance Designer',
      paragraphs: [
        'Since 2012 I spent several years working as a freelancer graphic designer on fields like illustration, advertising, branding, photography and, of course, UX/UI.',
        'As I was already doing web development as a hobby for years, I started taking web design and development projects that mostly included static website, UI re-design/implementation and WordPress websites. Some projects involved the use of Unity for several task, some related to programming.'
      ],
    },
    {
      title: '2017 - Freelance Developer',
      paragraphs: [
        'In 2017 David decided to dive deeper into software development since I always enjoyed programming more than anything else in my job, so I immersed himself into a learning process of all modern web development techniques by updating my current skills and learning new ones like Angular and TypeScript, which is currently one of my strength.',
    ...
    },
    {
      ...
      paragraphs: [
        'In 2022 David got hired by Publicis Global Delivery, a Publicis Groupe agency where I currently work.',
        'I have worked occasionally for other Publicis Groupe agencies depending on the demand, like Publicis Sapient and Epsilon. I\'m always ready for any challenge.',
      ],
    }
  ]
